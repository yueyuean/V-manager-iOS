...
- (id)initWithSectionTitles:(NSArray *)sectiontitles :(int)showType {
...
- (void)commonInit {
    ...
    self.selectionIndicatorBoxLayer.opacity = 0.1;
    ...
    if (self.type == HMSegmentedControlTypeText) {
        [self.sectionTitles enumerateObjectsUsingBlock:^(id titleString, NSUInteger idx, BOOL *stop) {
            ...
            if (self.selectedSegmentIndex == idx) {
                ...
                {
                      titleLayer.foregroundColor = [UIColor groupTableViewBackgroundColor].CGColor;
                }
