...
#define kVRGCalendarViewDayWidth SCREEN_WIDTH*44/320
#define kVRGCalendarViewDayHeight SCREEN_WIDTH*44/320

@protocol VRGCalendarViewDelegate;
@interface VRGCalendarView : UIView {
   
    id <VRGCalendarViewDelegate> __unsafe_unretained delegate;
