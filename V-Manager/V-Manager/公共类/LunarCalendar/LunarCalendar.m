...
-(void)InitializeValue
{
    ...
    NSString *buddhaday=[CalcUtility  getBuddhaday:lunarMonth day:lunarDay];
    if (buddhaday!=nil)
    {
        [holiday addObject:buddhaday];
    }
    
    NSString *guanyinzhaiday=[CalcUtility getGuanyinzhaiday:lunarMonth day:lunarDay];
    if (guanyinzhaiday!=nil)
    {
        [holiday addObject:guanyinzhaiday];
    }
    NSString *liuzhaiday=[CalcUtility  getLiuzhaiday:lunarMonth day:lunarDay];
    if (liuzhaiday!=nil)
    {
        [holiday addObject:liuzhaiday];
    }
    
    NSString *shizhaiday=[CalcUtility getShizhaiday:lunarMonth day:lunarDay];
    if (shizhaiday!=nil)
    {
        [holiday addObject:shizhaiday];
    }
    
    NSString *chineseHoliday= [CalcUtility  getChineseHoliday:lunarMonth day:lunarDay];
