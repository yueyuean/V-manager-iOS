...
//             [_imageView sd_setImageWithPreviousCachedImageWithURL:<#(NSURL *)#> andPlaceholderImage:<#(UIImage *)#> options:<#(SDWebImageOptions)#> progress:<#^(NSInteger receivedSize, NSInteger expectedSize)progressBlock#> completed:<#^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL)completedBlock#>
            
            [_imageView   sd_setImageWithPreviousCachedImageWithURL:url andPlaceholderImage:placeHolder options:SDWebImageRetryFailed progress:^(NSInteger receivedSize, NSInteger expectedSize) {
